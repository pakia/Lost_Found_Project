 ...
 @extends('Admin/incadmin/header')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          Lost Item Post Approve Request
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Lost Item Post Request</h3>
                ...
                <div class="box-footer clearfix">
                 ...
                 <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td><span class="label label-info"><a href="approve1&{{$data->id}}">Approve</a>|<a onclick="return confirm('Are you sure to delete this post?')" href="removelost&{{$data->id}}"> Remove </a></span></td>
